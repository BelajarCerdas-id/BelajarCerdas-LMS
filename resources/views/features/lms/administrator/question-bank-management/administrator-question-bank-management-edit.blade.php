@include('components/sidebar-beranda', [
    ...
    'linkBackButton' => $schoolId
        ? route('lms.questionBankManagementDetail.view.schoolPartner', [$role, $schoolName, $schoolId,  $kurikulumId, $kelasId, $mapelId, $source, $questionType, $questionCategory, $babId, $subBabId])
        : route('lms.questionBankManagementDetail.view.noSchoolPartner', [$role, $kurikulumId, $kelasId, $mapelId, $source, $questionType, $questionCategory, $babId, $subBabId]),

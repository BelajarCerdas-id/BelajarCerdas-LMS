                    ...
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
                        ...
                        <div class="flex flex-wrap items-center justify-end gap-3">
                            ...
                            <select id="chartPeriod"
                                class="h-11 px-4 pr-10 rounded-xl border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-sm transition-all duration-200 hover:border-gray-400 focus:border-[#0071BC] focus:ring-2 focus:ring-[#0071BC]/20 outline-none cursor-pointer hidden">

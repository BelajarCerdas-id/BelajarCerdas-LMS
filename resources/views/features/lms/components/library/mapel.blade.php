...
<!-- ================= LOOP BAB ================= -->   
@forelse($chapters as $topikId => $books)

@php
    $topikData = $topiks[$topikId] ?? null;
@endphp
...
<section class="section-card">
    ...
    <div class="mb-8">
        ...
        <h2 class="text-2xl font-bold">
            {{ $topikData->nama_topik ?? 'Topik Tidak Diketahui' }}
        </h2>

        @if($topikData?->deskripsi)
        <div class="mt-2 text-gray-600 text-sm">

            <span class="deskripsi-singkat">
                {{ \Illuminate\Support\Str::limit($topikData->deskripsi, 120) }}
            </span>

            @if(strlen($topikData->deskripsi) > 120)
            <details class="inline">
                <summary class="inline cursor-pointer text-blue-500">
                    baca selengkapnya
                </summary>
    ...
    <!-- ================= MODAL ================= -->
    <div id="modal-{{ Str::slug($topikData->nama_topik ?? $topikId) }}" class="modal-bg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <div
                    class="modal-close"
                    onclick="closeModal('{{ Str::slug($topikData->nama_topik ?? $topikId) }}')"
                >
                    ✕
                </div>

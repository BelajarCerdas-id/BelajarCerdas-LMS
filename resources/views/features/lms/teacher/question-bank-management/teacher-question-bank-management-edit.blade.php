@include('components/sidebar-beranda', [
    ...
    'linkBackButton' => route('lms.teacherQuestionBankManagement.detail.view', [$role, $schoolName, $schoolId, $kurikulumId, $kelasId, $mapelId, $source, $questionType, $questionCategory, $babId, $subBabId]),

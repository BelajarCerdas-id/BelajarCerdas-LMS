    ...
    <div class="relative left-72.5 w-[calc(100%-290px)] transition-all duration-500 ease-in-out hidden md:block">
        <div class="content">
            <div class="w-full h-24 bg-[#0071BC] shadow-lg flex items-center justify-between px-12.5">
                ...
                {{-- Dropdown Profile (Mobile Version Inside Desktop Wrapper?) --}}
    ...
    <div class="drawer md:hidden z-9999">
        ...
        <div class="drawer-side">
            ...
            <div class="bg-gray-50 min-h-full min-w-[65vw] flex flex-col">
                ...
                <!-- MENU -->
                <ul class="px-3 py-2 space-y-1 text-sm mt-6 flex flex-col gap-4">
...
@elseif (Auth::user()->role === 'Guru')
    ...
    <div class="drawer md:hidden z-9999">
        ...
        <div class="drawer-side">
            ...
            <div class="bg-gray-50 h-full min-w-[65vw] flex flex-col">
                ...
                <ul class="max-h-112.5 overflow-y-auto pb-6 pt-6 space-y-3">
                            ...
                            <div class="content-dropdown pl-6 pr-3.5 w-full">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="list-content-dropdown pl-4">
                                        <a href="{{ route('lms.teacherContentManagement.view', [
                                                'role' => Auth::user()->role,
                                                'schoolName' => Auth::user()->SchoolStaffProfile->SchoolPartner->nama_sekolah ?? 'sekolah',
                                                'schoolId' => Auth::user()->SchoolStaffProfile->SchoolPartner->id ?? 1
                                            ]) }}" class="link-href block py-2 text-[12px]">
                                            Content Mangement
                                        </a>
                                        <a href="{{ route('lms.teacherContentForRelease.view', [
                    ...
                    <li class="list-item mt-1">
                        <div class="dropdown-menu w-full flex flex-col items-start">
                            ...
                            <div class="content-dropdown pl-6 pr-3.5 w-full">
                                <div class="flex flex-col py-2 mt-1">
                                    <a href="{{ route('lms.teacherPolling.view', ['role' => Auth::user()->role, 'schoolName' => Auth::user()->SchoolStaffProfile->SchoolPartner->nama_sekolah ?? 'sekolah', 'schoolId' => Auth::user()->SchoolStaffProfile->SchoolPartner->id ?? 1]) }}" class="link-href block py-2 text-[13px] hover:text-gray-300 cursor-pointer">
                                        Polling
                                    </a>
                                </div>
                            </div>
                ...
                <li class="list-item">
                    <div class="dropdown-menu w-full flex flex-col items-start">
                        <div class="toggle-menu-sidebar w-full flex items-center gap-3 relative cursor-pointer px-3 py-2 rounded-lg hover:bg-[#FFFFFF26] transition">
                            ...
                            <span class="text-[14px]">Monitoring Sekolah</span>
                            <i class="fas fa-chevron-down absolute right-3 text-[13px]"></i>
                        </div>
        ...
        <div class="flex-1 bg-[#0071BC] text-white flex flex-col">
            ...
            <ul class="max-h-112.5 overflow-y-auto pb-6 pt-6 space-y-3">
                ...
                <li class="list-item">
                    <div class="dropdown-menu w-full flex flex-col items-start">
                        <div class="toggle-menu-sidebar w-full flex items-center gap-3 relative cursor-pointer px-3 py-2 rounded-lg hover:bg-[#FFFFFF26] transition">
                            <i class="fa-solid fa-child text-[15px] w-5 text-center"></i>
                            <span class="text-[14px]">Perkembangan Anak</span>
                            <i class="fas fa-chevron-down absolute right-3 text-[13px]"></i>
                        </div>
...
@elseif (in_array(Auth::user()->role, ['Yayasan']))
    @php
        $foundationId = Auth::user()->SchoolFoundationProfile->school_foundation_id;

        $financeAccessLinks = collect();

        if ($foundationId) {
            $financeAccessLinks = \App\Models\SchoolFoundationFinanceAccess::with([
                'SchoolPartner:id,nama_sekolah'
            ])->where('status_access', true)->whereNotNull('link')->whereHas('SchoolPartner', function ($query) use ($foundationId) {
    ...
    <aside class="sidebar-beranda-student hidden md:flex flex-col w-72">
        ...
        <div class="h-40 bg-white flex flex-col items-center justify-center border-b text-gray-500 relative group">
            ...
            <div id="logo-wrapper" class="flex items-center justify-center overflow-hidden">
                ...
                @if(!empty(Auth::user()->SchoolFoundationProfile->SchoolFoundation->logo))
                    <img id="school-logo-preview" src="{{ asset(Auth::user()->SchoolFoundationProfile->SchoolFoundation->logo) }}" class="h-26 object-cover">
                @else
                    <i class="fa-solid fa-school text-4xl mb-2"></i>
                @endif
            </div>
        ...
        <div class="flex-1 bg-[#0071BC] text-white flex flex-col">
            ...
            <ul class="max-h-112.5 overflow-y-auto pb-6 pt-6 space-y-3">
                ...
                <li class="list-item">
                    <div class="content-menu flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[#FFFFFF26] transition">
                        <i class="fa-solid fa-house text-[15px] w-5 text-center"></i>
                        <a href="{{ route('lms.foundation.dashboard.view', [
                                'role' => Auth::user()->role,
                                'foundationId' => Auth::user()->SchoolFoundationProfile->school_foundation_id ?? null,
                            ]) }}" class="link-href text-[14px]">
                            Beranda
                        </a>
                    </div>
                ...
                <li class="list-item">
                    <div class="content-menu flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[#FFFFFF26] transition">
                        ...
                        <i class="fa-solid fa-chalkboard-user w-5 text-center text-[15px]"></i>
                ...
                <li class="list-item">
                    <div class="content-menu flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[#FFFFFF26] transition">
                        ...
                        <i class="fa-solid fa-face-smile w-5 text-center text-[15px]"></i>
                ...
                @if ($financeAccessLinks->isNotEmpty())
                    <li class="list-item mt-1">
                        <div class="dropdown-menu w-full flex flex-col items-start">
                            <div class="toggle-menu-sidebar w-full flex items-center gap-3 relative cursor-pointer px-3 py-2 rounded-lg hover:bg-[#FFFFFF26] transition">
                                <i class="fa-brands fa-google-drive text-[15px] w-5 text-center"></i>
                                <span class="text-[14px]">Link Keuangan</span>
                                <i id="rotate-icon" class="fas fa-chevron-down absolute right-3 text-[13px]"></i>
                            </div>

                            <div class="content-dropdown pl-6 pr-3.5 w-full">
                                <div class="flex flex-col py-2 mt-1">
                                    @foreach ($financeAccessLinks as $financeAccess)
                                        <a href="{{ $financeAccess->link }}" target="_blank" rel="noopener noreferrer"
                                            class="link-href block py-2 text-[12px] hover:text-gray-300 cursor-pointer">

                                            <span class="truncate">
                                                {{ $financeAccess->SchoolPartner->nama_sekolah }}
                                            </span>
                                        </a>
                                    @endforeach
                                </div>
                ...
                <div class="list-item-button-profile m-2 z-40">
                    <div class="dropdown-menu hidden lg:block">
                        <div class="flex items-center gap-3.5 relative">
                            <div class="flex flex-col">
                                <span class="text-[12px] text-white font-semibold leading-6">
                                    {{ Str::limit(Auth::user()->SchoolFoundationProfile->nama_lengkap ?? '', 20) }}
                                </span>
                                <span class="text-[11px] text-white font-semibold leading-6">
                                    {{ Str::limit(Auth::user()->role ?? '', 20) }}
                                </span>
            ...
            <div class="bg-gray-50 min-h-full min-w-[65vw] flex flex-col">
                ...
                <div class="relative flex flex-col items-center">
                    ...
                    <div class="mx-4 mt-4 p-4 flex flex-col items-center">
                        <!-- LOGO -->
                        @if(!empty(Auth::user()->SchoolFoundationProfile->SchoolFoundation->logo))
                            <img src="{{ asset(Auth::user()->SchoolFoundationProfile->SchoolFoundation->logo) }}"
                                class="w-32 h-20 rounded-full object-contain bg-white" alt="Logo Sekolah">
                        @else
                            <div class="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center border border-gray-200 mb-2">
                                <i class="fa-solid fa-school text-3xl text-gray-400"></i>
...
@else
    <div class="flex flex-col items-center justify-center min-h-screen bg-slate-50 px-4">
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 flex flex-col items-center text-center max-w-sm">
            <i class="fas fa-triangle-exclamation text-6xl text-amber-400 mb-4"></i>
            <h1 class="text-2xl font-bold text-slate-800 mb-2">Akses Ditolak</h1>
            <p class="text-slate-500 mb-8">Maaf, Anda tidak memiliki akses ke dashboard ini.</p>

...
use App\Imports\SchoolPartnerHandler\LmsUsersHandler;
...
class SchoolPartnerUsersImport implements ToCollection, WithHeadingRow, WithStartRow, WithTitle
{
    protected $userId;

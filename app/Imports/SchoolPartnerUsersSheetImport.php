...
class SchoolPartnerUsersSheetImport implements WithMultipleSheets
{
    protected $userId;
    protected $file;
    ...
    public function sheets(): array
    {
        ...
        foreach ($spreadsheet->getSheetNames() as $sheetName) {
            ...
            $sheets[$sheetName] = new SchoolPartnerUsersImport($this->userId, $sheetName, $this->onlyValidate);
        }

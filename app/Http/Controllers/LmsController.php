...
class LmsController extends Controller
{
    ...
    public function paginateSubjectPassingGradeCriteria(Request $request, $schoolName, $schoolId)
    {
        ...
        // QUERY DATA KKM
        $query = SubjectPassingGradeCriteria::with(['SchoolPartner', 'Kelas', 'Mapel'])->where('school_partner_id', $schoolId)->where('school_year', $searchYear);

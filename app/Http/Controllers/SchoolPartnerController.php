...
class SchoolPartnerController extends Controller
{
    ...
    public function bulkUploadSchoolPartnerValidate(Request $request)
    {
        ...
        try {
            $userId = Auth::id();
            Excel::import(new SchoolPartnerSheetImport($userId, $request->file('bulkUpload-school-partner'), true), $request->file('bulkUpload-school-partner'));
    ...
    public function bulkUploadSchoolPartner(Request $request)
    {
        ...
        try {
            $userId = Auth::id();
            Excel::import(new SchoolPartnerSheetImport($userId, $request->file('bulkUpload-school-partner'), false), $request->file('bulkUpload-school-partner'));

        ...
        success: function (response) {
            ...
            containerDropdownClass.innerHTML = `
                <div class="flex flex-col w-full">
                    ...
                    <select id="dropdown-assessment-management-filter-class" class="w-full h-11 bg-white border border-gray-300 rounded-xl px-4 pr-10 text-sm font-medium text-gray-700 outline-none transition-all duration-200 hover:border-gray-400 focus:border-[#0071BC] focus:ring-2 focus:ring-[#0071BC]/20 cursor-pointer shadow-xs">

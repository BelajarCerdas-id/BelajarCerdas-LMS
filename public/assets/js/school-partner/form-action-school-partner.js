...
$('#submit-button').on('click', function (e) {
    ...
    const form = $('#school-partner-form')[0];
    ...
    $.ajax({
        url: `/school-subscription/validate`,
        method: 'POST',
        headers: {
...
function startUpload(formData, btn, defaultButtonHtml) {
    ...
    currentUploadRequest = $.ajax({
        ...
        success: function (response) {
            ...
            paginateSchoolContract($('#search_school').val(), 1, true);
...
function showValidationError(errors) {
    ...
    $('#school-partner-form .text-red-500').text('');
    $('#school-partner-form').find('.border-red-400').removeClass('border-red-400 border');

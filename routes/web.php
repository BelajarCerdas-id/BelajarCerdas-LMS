...
Route::middleware([AuthMiddleware::class])->group(function () {
    ...
    // ROUTES STUDENT LMS
    // learning routes
    Route::get('/lms/siswa/{schoolName}/{schoolId}', [LmsController::class, 'lmsStudentView'])->name('lms.student.view');
    ...
    // ROUTES TEACHER LMS
    // content management
    Route::get('/lms/guru/{schoolName}/{schoolId}', [LmsController::class, 'lmsTeacherView'])->name('lms.teacher.view');
